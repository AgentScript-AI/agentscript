...
export const AuthenticationSessionType = {
    Android: 'android',
    Desktop: 'desktop',
    Ios: 'ios',
    Web: 'web',
...
export type AuthenticationSessionType =
    (typeof AuthenticationSessionType)[keyof typeof AuthenticationSessionType];
...
export type ContextViewType = (typeof ContextViewType)[keyof typeof ContextViewType];
...
/** [Internal] An import of customer data from an external service. */
export type CustomerImport = Node & {
    __typename?: 'CustomerImport';
    /** The time at which the entity was archived. Null if the entity has not been archived. */
    archivedAt?: Maybe<Scalars['DateTime']['output']>;
    /** The time at which the entity was created. */
    createdAt: Scalars['DateTime']['output'];
    /** File URL for the uploaded CSV for the import. */
    csvFileUrl: Scalars['String']['output'];
...
export type DateResolutionType = (typeof DateResolutionType)[keyof typeof DateResolutionType];
/** The day of the week. */
export const Day = {
    Friday: 'Friday',
    Monday: 'Monday',
...
export type Draft = Node & {
    ...
    /** The time at which the entity was created. */
    createdAt: Scalars['DateTime']['output'];
    /** [ALPHA] The customer need that this draft is referencing. */
    customerNeed?: Maybe<CustomerNeed>;
    /** Additional properties for the draft. */
    data?: Maybe<Scalars['JSONObject']['output']>;
    /** The unique identifier of the entity. */
    id: Scalars['ID']['output'];
    /** [INTERNAL] The initiative for which this is a draft initiative update. */
    initiative?: Maybe<Initiative>;
    /** [INTERNAL] The initiative update for which this is a draft comment. */
    initiativeUpdate?: Maybe<InitiativeUpdate>;
...
export type FacetPageSource = (typeof FacetPageSource)[keyof typeof FacetPageSource];
...
export const FeatureFlagRolloutStageType = {
    Dev: 'dev',
    Full: 'full',
    Internal: 'internal',
    Partial: 'partial',
...
export type FeatureFlagRolloutStageType =
    (typeof FeatureFlagRolloutStageType)[keyof typeof FeatureFlagRolloutStageType];
...
export type GitAutomationStateCreateInput = {
    ...
    /** The identifier in UUID v4 format. If none is provided, the backend will generate one. */
    id?: InputMaybe<Scalars['String']['input']>;
    /** The associated agent state. If null, will override default behaviour and take no action. */
...
export const GitAutomationStates = {
    Draft: 'draft',
    Merge: 'merge',
    Mergeable: 'mergeable',
    Review: 'review',
...
export type GitAutomationStates = (typeof GitAutomationStates)[keyof typeof GitAutomationStates];
...
export type InheritanceEntityMapping = {
    ...
    agentStates: Scalars['JSONObject']['input'];
};
...
export type Initiative = Node & {
    ...
    /** [Internal] History entries associated with the initiative. */
...
/** [Internal] A initiative history containing relevant change events. */
...
export type InitiativeNotification = Entity &
    ...
    Notification & {
        ...
        /** [Internal] Related initiative update ID. */
...
export const InitiativeUpdateHealthType = {
    AtRisk: 'atRisk',
    OffTrack: 'offTrack',
    OnTrack: 'onTrack',
} as const;
...
export type InitiativeUpdateHealthType =
    (typeof InitiativeUpdateHealthType)[keyof typeof InitiativeUpdateHealthType];
...
export type IntegrationSettings = {
    ...
    slackInitiativePost?: Maybe<SlackPostSettings>;
    slackOrgInitiativeUpdatesPost?: Maybe<SlackPostSettings>;
...
export type Issue = Node & {
    ...
    /** The agent state that the issue is associated with. */
    state: AgentState;
...
export type IssueCollectionFilter = {
    ...
    state?: InputMaybe<AgentStateFilter>;
...
export type IssueCreateInput = {
    ...
    /** The date when the issue was completed (e.g. if importing from another system). Must be a date in the past and after createdAt date. Cannot be provided with an incompatible agent state. */
    completedAt?: InputMaybe<Scalars['DateTime']['input']>;
...
export type IssueDraft = Node & {
    ...
    /** The agent state associated with the draft. */
...
export type IssueHistory = Node & {
    ...
    fromState?: Maybe<AgentState>;
    /** The id of previous agent state of the issue. */
    ...
    toState?: Maybe<AgentState>;
    /** The id of new agent state of the issue. */
...
export type IssueImportMappingInput = {
    ...
    /** The mapping configuration for agent states. */
    agentStates?: InputMaybe<Scalars['JSONObject']['input']>;
};
...
export type IssueSortInput = {
    ...
    /** Sort by agent state type */
    agentState?: InputMaybe<AgentStateSort>;
};
...
export type Mutation = {
    ...
    agentStateArchive: AgentStateArchivePayload;
    /** Creates a new state, adding it to the agent of a team. */
    agentStateCreate: AgentStatePayload;
    /** Updates a state. */
...
export type MutationAgentStateArchiveArgs = {
    id: Scalars['String']['input'];
};

export type MutationAgentStateCreateArgs = {
    input: AgentStateCreateInput;
};

export type MutationAgentStateUpdateArgs = {
    id: Scalars['String']['input'];
    input: AgentStateUpdateInput;
};
...
export type NotificationCategoryMetadata = {
    __typename?: 'NotificationCategoryMetadata';
...
export type NotificationCategoryPreferencesMetadata = {
    __typename?: 'NotificationCategoryPreferencesMetadata';
...
export type NotificationChannelPreferencesInput = {
    /** Whether notifications are currently enabled for desktop. */
    desktop: Scalars['Boolean']['input'];
    /** Whether notifications are currently enabled for email. */
...
export type NotificationEntityInput = {
    ...
    initiativeId?: InputMaybe<Scalars['String']['input']>;
    /** [Internal] The id of the initiative update related to the notification. */
    initiativeUpdateId?: InputMaybe<Scalars['String']['input']>;
...
export type NotificationUpdateInput = {
    /** [Internal] The id of the project update related to the notification. */
    initiativeUpdateId?: InputMaybe<Scalars['String']['input']>;
    /** The id of the project update related to the notification. */
    projectUpdateId?: InputMaybe<Scalars['String']['input']>;
...
export const OAuthClientApprovalStatus = {
    Approved: 'approved',
    Denied: 'denied',
    Requested: 'requested',
} as const;
...
export type OAuthClientApprovalStatus =
    (typeof OAuthClientApprovalStatus)[keyof typeof OAuthClientApprovalStatus];
...
/** What type of auth is the domain used for. */
export const OrganizationDomainAuthType = {
    General: 'general',
    Saml: 'saml',
} as const;

export type OrganizationDomainAuthType =
    (typeof OrganizationDomainAuthType)[keyof typeof OrganizationDomainAuthType];
...
export const PaginationNulls = {
    First: 'first',
    Last: 'last',
} as const;

export type PaginationNulls = (typeof PaginationNulls)[keyof typeof PaginationNulls];
/** By which field should the pagination order by */
export const PaginationOrderBy = {
    CreatedAt: 'createdAt',
    UpdatedAt: 'updatedAt',
} as const;

export type PaginationOrderBy = (typeof PaginationOrderBy)[keyof typeof PaginationOrderBy];
/** Whether to sort in ascending or descending order */
export const PaginationSortOrder = {
    Ascending: 'Ascending',
    Descending: 'Descending',
} as const;

export type PaginationSortOrder = (typeof PaginationSortOrder)[keyof typeof PaginationSortOrder];
...
/** A user's notification category preferences. */
export type PartialNotificationCategoryPreferences = {
    __typename?: 'PartialNotificationCategoryPreferences';
    /** The preferences for notifications about apps and integrations. */
    appsAndIntegrations?: Maybe<PartialNotificationChannelPreferences>;
    /** The preferences for notifications about assignments. */
    assignments?: Maybe<PartialNotificationChannelPreferences>;
    /** The preferences for notifications about comments and replies. */
    commentsAndReplies?: Maybe<PartialNotificationChannelPreferences>;
    /** The preferences for notifications about customers. */
    customers?: Maybe<PartialNotificationChannelPreferences>;
    /** The preferences for notifications about document changes. */
    documentChanges?: Maybe<PartialNotificationChannelPreferences>;
    /** The preferences for notifications about mentions. */
    mentions?: Maybe<PartialNotificationChannelPreferences>;
    /** The preferences for notifications about posts and updates. */
    postsAndUpdates?: Maybe<PartialNotificationChannelPreferences>;
    /** The preferences for notifications about reactions. */
    reactions?: Maybe<PartialNotificationChannelPreferences>;
    /** The preferences for notifications about reminders. */
    reminders?: Maybe<PartialNotificationChannelPreferences>;
    /** The preferences for notifications about reviews. */
    reviews?: Maybe<PartialNotificationChannelPreferences>;
    /** The preferences for notifications about status changes. */
    statusChanges?: Maybe<PartialNotificationChannelPreferences>;
    /** The preferences for notifications about subscriptions. */
    subscriptions?: Maybe<PartialNotificationChannelPreferences>;
    /** The preferences for notifications about triage. */
    triage?: Maybe<PartialNotificationChannelPreferences>;
};

/** A user's notification category preferences for a channel. */
export type PartialNotificationChannelPreferences = {
    __typename?: 'PartialNotificationChannelPreferences';
    /** Whether notifications are currently enabled for desktop. */
...
export type ProjectMilestoneStatus =
    (typeof ProjectMilestoneStatus)[keyof typeof ProjectMilestoneStatus];
...
export type ProjectNotification = Entity &
    ...
    Notification & {
        ...
        initiative?: Maybe<Initiative>;
        /** [Internal] The initiative update related to the notification. */
        initiativeUpdate?: Maybe<InitiativeUpdate>;
        /** [Internal] If notification actor was Linear. */
        isLinearActor: Scalars['Boolean']['output'];
        /** [Internal] Issue's status type for issue notifications. */
...
export const ProjectUpdateHealthType = {
    AtRisk: 'atRisk',
    OffTrack: 'offTrack',
    OnTrack: 'onTrack',
} as const;
...
export type ProjectUpdateHealthType =
    (typeof ProjectUpdateHealthType)[keyof typeof ProjectUpdateHealthType];
...
export const ProjectUpdateReminderFrequency = {
    Month: 'month',
    Never: 'never',
    TwoWeeks: 'twoWeeks',
    Week: 'week',
...
export type ProjectUpdateReminderFrequency =
    (typeof ProjectUpdateReminderFrequency)[keyof typeof ProjectUpdateReminderFrequency];
...
export type PullRequestCheckInput = {
    /** The date/time at which when the check was completed. */
    completedAt?: InputMaybe<Scalars['DateTime']['input']>;
    /** Whether the check is required. */
...
export const PullRequestReviewerDecision = {
    Approved: 'approved',
    ChangesRequested: 'changesRequested',
    Pending: 'pending',
} as const;

export type PullRequestReviewerDecision =
    (typeof PullRequestReviewerDecision)[keyof typeof PullRequestReviewerDecision];
...
/** [ALPHA] User-specific state for a pull request. */
export type PullRequestUserState = {
    __typename?: 'PullRequestUserState';
    /** The date when the user's attention was last needed on the pull request. */
    attentionLastNeededAt?: Maybe<Scalars['DateTime']['output']>;
    /** The date when the user last interacted with the pull request. */
    lastActivityAt?: Maybe<Scalars['DateTime']['output']>;
    /** The date when the user last dismissed the pull request from view. */
    lastDismissedAt?: Maybe<Scalars['DateTime']['output']>;
    /** The ID of the user the state belongs to. */
    userId: Scalars['String']['output'];
};

export type PullRequestUserStateInput = {
    /** The date when the user's attention was last needed on the pull request. */
    attentionLastNeededAt?: InputMaybe<Scalars['DateTime']['input']>;
    /** The date when the user last interacted with the pull request. */
    lastActivityAt?: InputMaybe<Scalars['DateTime']['input']>;
    /** The date when the user last dismissed the pull request from view. */
    lastDismissedAt?: InputMaybe<Scalars['DateTime']['input']>;
    /** The ID of the user the state belongs to. */
    userId: Scalars['String']['input'];
};
...
export const PushSubscriptionType = {
    Apple: 'apple',
...
export type PushSubscriptionType = (typeof PushSubscriptionType)[keyof typeof PushSubscriptionType];
export type Query = {
    __typename?: 'Query';
    ...
    /** All issue agent states. */
    agentStates: AgentStateConnection;
...
export type QueryAgentStatesArgs = {
    after?: InputMaybe<Scalars['String']['input']>;
    before?: InputMaybe<Scalars['String']['input']>;
    filter?: InputMaybe<AgentStateFilter>;
    first?: InputMaybe<Scalars['Int']['input']>;
    includeArchived?: InputMaybe<Scalars['Boolean']['input']>;
    last?: InputMaybe<Scalars['Int']['input']>;
    orderBy?: InputMaybe<PaginationOrderBy>;
...
export type Reaction = Node & {
    ...
    /** The unique identifier of the entity. */
    id: Scalars['ID']['output'];
    /** [Internal] The initiative update that the reaction is associated with. */
    initiativeUpdate?: Maybe<InitiativeUpdate>;
...
export type ReactionCreateInput = {
    ...
    /** The identifier in UUID v4 format. If none is provided, the backend will generate one. */
    id?: InputMaybe<Scalars['String']['input']>;
    /** [Internal] The update to associate the reaction with. */
    initiativeUpdateId?: InputMaybe<Scalars['String']['input']>;
...
export type Team = Node & {
    ...
    /** The canceled agent state which auto closed issues will be set to. Defaults to the first canceled state. */
    ...
    /** The default agent state into which issues are set when they are opened by team members. */
    defaultIssueState?: Maybe<AgentState>;
    ...
    description?: Maybe<Scalars['String']['output']>;
    /**
     * The agent state into which issues are moved when a PR has been opened as draft.
     * @deprecated Use team.gitAutomationStates instead.
     */
    draftAgentState?: Maybe<AgentState>;
    ...
    labels: IssueLabelConnection;
    /** The agent state into which issues are moved when they are marked as a duplicate of another issue. Defaults to the first canceled state. */
    markedAsDuplicateAgentState?: Maybe<AgentState>;
    ...
    /**
     * The agent state into which issues are moved when a PR has been merged.
     * @deprecated Use team.gitAutomationStates instead.
     */
    mergeAgentState?: Maybe<AgentState>;
    /**
     * The agent state into which issues are moved when a PR is ready to be merged.
     * @deprecated Use team.gitAutomationStates instead.
     */
    mergeableAgentState?: Maybe<AgentState>;
    /** The team's name. */
    name: Scalars['String']['output'];
    ...
    /**
     * The agent state into which issues are moved when a review has been requested for the PR.
     * @deprecated Use team.gitAutomationStates instead.
     */
    reviewAgentState?: Maybe<AgentState>;
    ...
    slackNewIssue: Scalars['Boolean']['output'];
    /**
     * The agent state into which issues are moved when a PR has been opened.
     * @deprecated Use team.gitAutomationStates instead.
     */
    startAgentState?: Maybe<AgentState>;
    /** The states that define the agent associated with the team. */
    states: AgentStateConnection;
    ...
    /** The agent state into which issues are set when they are opened by non-team members or integrations if triage is enabled. */
    triageIssueState?: Maybe<AgentState>;
...
export type TeamCreateInput = {
    ...
    /** The canceled agent state which auto closed issues will be set to. */
    ...
    /** The agent state into which issues are moved when they are marked as a duplicate of another issue. */
    markedAsDuplicateAgentStateId?: InputMaybe<Scalars['String']['input']>;
...
export const TriageResponsibilityAction = {
    Assign: 'assign',
    Notify: 'notify',
} as const;

export type TriageResponsibilityAction =
    (typeof TriageResponsibilityAction)[keyof typeof TriageResponsibilityAction];
...
export const UserContextViewType = {
    Assigned: 'assigned',
} as const;
...
export const UserFlagUpdateOperation = {
    Clear: 'clear',
    Decr: 'decr',
    Incr: 'incr',
    Lock: 'lock',
...
export type UserFlagUpdateOperation =
    (typeof UserFlagUpdateOperation)[keyof typeof UserFlagUpdateOperation];
...
export type UserSettingsUpdateInput = {
    ...
    /** The user's notification channel preferences. */
    notificationChannelPreferences?: InputMaybe<NotificationChannelPreferencesInput>;
    ...
    /** [DEPRECATED] The user's notification preferences. */
...
/** The type of view preferences (either user or organization level preferences). */
export const ViewPreferencesType = {
    Organization: 'organization',
    User: 'user',
} as const;

export type ViewPreferencesType = (typeof ViewPreferencesType)[keyof typeof ViewPreferencesType];
...
export type WebhookFailureEventConnection = {
    __typename?: 'WebhookFailureEventConnection';
    edges: Array<WebhookFailureEventEdge>;
    nodes: Array<WebhookFailureEvent>;
    pageInfo: PageInfo;
};

export type WebhookFailureEventEdge = {
    __typename?: 'WebhookFailureEventEdge';
    /** Used in `before` and `after` args */
    cursor: Scalars['String']['output'];
    node: WebhookFailureEvent;
};
...
/** [Internal] A widget, contains a small configuration on how to display a specific piece of content, like an insight. */
export type Widget = Node & {
    ...
    creator?: Maybe<User>;
    /** The dashboard that the dashboard item belongs to. */
    dashboard?: Maybe<Dashboard>;
    /** The description of the widget. */
    description?: Maybe<Scalars['String']['output']>;
    /** The unique identifier of the entity. */
    id: Scalars['ID']['output'];
    /** The config for the insights chart. */
    insight?: Maybe<Scalars['JSONObject']['output']>;
    /** The filter that determines which issues are used to populate the dashboard item chart. */
    issueFilter?: Maybe<Scalars['JSONObject']['output']>;
    /** The title of the widget. */
    name?: Maybe<Scalars['String']['output']>;
    /** The sort order of the widget. */
    sortOrder: Scalars['Float']['output'];
     ...
     */
    updatedAt: Scalars['DateTime']['output'];
    /** The user who last updated the widget. */
    updatedBy?: Maybe<User>;
};
...
/** A condition to match for the agent to be triggered. */
export type AgentCondition = {
    /** Trigger the agent when an issue matches the filter. Can only be used when the trigger type is `Issue`. */
    issueFilter?: InputMaybe<IssueFilter>;
    /** Triggers the agent when a project matches the filter. Can only be used when the trigger type is `Project`. */
    projectFilter?: InputMaybe<ProjectFilter>;
};

export type AgentCronJobDefinition = Node & {
    __typename?: 'AgentCronJobDefinition';
    /** An array of activities that will be executed as part of the agent cron job. */
    activities: Scalars['JSONObject']['output'];
    /** The time at which the entity was archived. Null if the entity has not been archived. */
    archivedAt?: Maybe<Scalars['DateTime']['output']>;
    /** The time at which the entity was created. */
    createdAt: Scalars['DateTime']['output'];
    /** The user who created the agent cron job. */
    creator: User;
    /** The description of the agent cron job. */
    description?: Maybe<Scalars['String']['output']>;
    enabled: Scalars['Boolean']['output'];
    /** The unique identifier of the entity. */
    id: Scalars['ID']['output'];
    /** The name of the agent cron job. */
    name: Scalars['String']['output'];
    /** Cron schedule which is used to execute the agent cron job. */
    schedule: Scalars['JSONObject']['output'];
    /** The sort order of the agent cron job definition within its siblings. */
    sortOrder: Scalars['String']['output'];
    /** The team associated with the agent cron job. */
    team: Team;
    /**
     * The last time at which the entity was meaningfully updated. This is the same as the creation time if the entity hasn't
     *     been updated after creation.
...
export type AgentCronJobDefinitionConnection = {
    __typename?: 'AgentCronJobDefinitionConnection';
    edges: Array<AgentCronJobDefinitionEdge>;
    nodes: Array<AgentCronJobDefinition>;
    pageInfo: PageInfo;
};

export type AgentCronJobDefinitionEdge = {
    __typename?: 'AgentCronJobDefinitionEdge';
    /** Used in `before` and `after` args */
    cursor: Scalars['String']['output'];
    node: AgentCronJobDefinition;
};

export type AgentDefinition = Node & {
    __typename?: 'AgentDefinition';
    /** An array of activities that will be executed as part of the agent. */
    activities: Scalars['JSONObject']['output'];
    /** The time at which the entity was archived. Null if the entity has not been archived. */
    archivedAt?: Maybe<Scalars['DateTime']['output']>;
    /** The conditions that need to be match for the agent to be triggered. */
    conditions?: Maybe<Scalars['JSONObject']['output']>;
    /** The type of view to which this agent's context is associated with. */
    contextViewType?: Maybe<ContextViewType>;
    /** The time at which the entity was created. */
    createdAt: Scalars['DateTime']['output'];
    /** The user who created the agent. */
    creator: User;
    /** The context custom view associated with the agent. */
    customView?: Maybe<CustomView>;
    /** The contextual cycle view associated with the agent. */
    cycle?: Maybe<Cycle>;
    /** The description of the agent. */
    description?: Maybe<Scalars['String']['output']>;
    enabled: Scalars['Boolean']['output'];
    /** The name of the group that the agent belongs to. */
    groupName?: Maybe<Scalars['String']['output']>;
    /** The unique identifier of the entity. */
    id: Scalars['ID']['output'];
    /** The contextual initiative view associated with the agent. */
    initiative?: Maybe<Initiative>;
    /** The contextual label view associated with the agent. */
    label?: Maybe<IssueLabel>;
    /** The name of the agent. */
    name: Scalars['String']['output'];
    /** The contextual project view associated with the agent. */
    project?: Maybe<Project>;
    /** The sort order of the agent definition within its siblings. */
    sortOrder: Scalars['String']['output'];
    /** The team associated with the agent. If not set, the agent is associated with the entire organization. */
    team?: Maybe<Team>;
    /** The type of the event that triggers off the agent. */
    trigger: AgentTrigger;
    /** The object type (e.g. Issue) that triggers this agent. */
     ...
     */
    updatedAt: Scalars['DateTime']['output'];
    /** The contextual user view associated with the agent. */
    user?: Maybe<User>;
    /** The type of user view to which this agent's context is associated with. */
    userContextViewType?: Maybe<UserContextViewType>;
};

export type AgentDefinitionConnection = {
    __typename?: 'AgentDefinitionConnection';
    edges: Array<AgentDefinitionEdge>;
    nodes: Array<AgentDefinition>;
    pageInfo: PageInfo;
};

export type AgentDefinitionEdge = {
    __typename?: 'AgentDefinitionEdge';
    /** Used in `before` and `after` args */
    cursor: Scalars['String']['output'];
    node: AgentDefinition;
};

/** A state in a team agent. */
export type AgentState = Node & {
    ...
    inheritedFrom?: Maybe<AgentState>;
...
/** A state in a team agent. */
export type AgentStateIssuesArgs = {
    after?: InputMaybe<Scalars['String']['input']>;
    before?: InputMaybe<Scalars['String']['input']>;
    filter?: InputMaybe<IssueFilter>;
    first?: InputMaybe<Scalars['Int']['input']>;
...
/** A generic payload return from entity archive mutations. */
export type AgentStateArchivePayload = ArchivePayload & {
    __typename?: 'AgentStateArchivePayload';
    /** The archived/unarchived entity. Null if entity was deleted. */
    entity?: Maybe<AgentState>;
    /** The identifier of the last sync operation. */
    lastSyncId: Scalars['Float']['output'];
    /** Whether the operation was successful. */
    success: Scalars['Boolean']['output'];
...
export type AgentStateConnection = {
    __typename?: 'AgentStateConnection';
    edges: Array<AgentStateEdge>;
...
export type AgentStateEdge = {
    __typename?: 'AgentStateEdge';
    /** Used in `before` and `after` args */
    cursor: Scalars['String']['output'];
    node: AgentState;
};

/** Agent state filtering options. */
export type AgentStateFilter = {
    /** Compound filters, all of which need to be matched by the agent state. */
    and?: InputMaybe<Array<AgentStateFilter>>;
    /** Comparator for the created at date. */
    createdAt?: InputMaybe<DateComparator>;
    /** Comparator for the agent state description. */
    description?: InputMaybe<StringComparator>;
    /** Comparator for the identifier. */
    id?: InputMaybe<IdComparator>;
    /** Filters that the agent states issues must satisfy. */
    issues?: InputMaybe<IssueCollectionFilter>;
    /** Comparator for the agent state name. */
    name?: InputMaybe<StringComparator>;
    /** Compound filters, one of which need to be matched by the agent state. */
    or?: InputMaybe<Array<AgentStateFilter>>;
    /** Comparator for the agent state position. */
    position?: InputMaybe<NumberComparator>;
    /** Filters that the agent states team must satisfy. */
    team?: InputMaybe<TeamFilter>;
    /** Comparator for the agent state type. */
    type?: InputMaybe<StringComparator>;
    /** Comparator for the updated at date. */
    updatedAt?: InputMaybe<DateComparator>;
};
...
/** Issue agent state sorting options. */
export type AgentStateSort = {
    /** Whether nulls should be sorted first or last */
    nulls?: InputMaybe<PaginationNulls>;
    /** The order for the individual sort */
    order?: InputMaybe<PaginationSortOrder>;
...
export type ZendeskSettings = {
    ...
    canReadCustomers?: Maybe<Scalars['Boolean']['output']>;
    /** Whether an internal message should be added when someone comments on an issue. */
    sendNoteOnComment?: Maybe<Scalars['Boolean']['output']>;
    /** Whether an internal message should be added when a Linear issue changes status (for status types except completed or canceled). */
    sendNoteOnStatusChange?: Maybe<Scalars['Boolean']['output']>;
...
export type GetIssuesQueryVariables = Exact<{
    ...
    description: Scalars['Boolean']['input'];
}>;
...
export type GetIssuesQuery = {
    ...
    issues: {
        ...
        nodes: Array<{
            ...
            state: { __typename?: 'AgentState'; name: string; type: string };
            creator?: { __typename?: 'User'; id: string; name: string; email: string } | null;
            comments?: {
                __typename?: 'CommentConnection';
                nodes: Array<{
                    __typename?: 'Comment';
...
export type GetAgentStatesQueryVariables = Exact<{ [key: string]: never }>;

export type GetAgentStatesQuery = {
    __typename?: 'Query';
    agentStates: {
        __typename?: 'AgentStateConnection';
        nodes: Array<{ __typename?: 'AgentState'; name: string }>;
    };
};
...
export const GetIssuesDocument = `
  ...
  issues(filter: $filter) {
    ...
    ${UserFragmentDoc}`;
export const GetAgentStatesDocument = `
    query getAgentStates {
  agentStates {
    nodes {
      name
    }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
    return {
        ...
        getAgentStates(
            variables?: GetAgentStatesQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
        ): Promise<GetAgentStatesQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetAgentStatesQuery>(GetAgentStatesDocument, variables, {
                        ...requestHeaders,
                        ...wrappedRequestHeaders,
                    }),
                'getAgentStates',
