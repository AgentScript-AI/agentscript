...
export type GetIssuesQuery = {
    ...
    issues: {
        ...
        nodes: Array<{
            ...
            state: { __typename?: 'WorkflowState'; name: string; type: string };
...
export type GetWorkflowStatesQuery = {
    ...
    workflowStates: {
        __typename?: 'WorkflowStateConnection';
        nodes: Array<{ __typename?: 'WorkflowState'; name: string }>;
    };
};
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
    return {
        ...
        getWorkflowStates(
            variables?: GetWorkflowStatesQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
        ): Promise<GetWorkflowStatesQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetWorkflowStatesQuery>(GetWorkflowStatesDocument, variables, {
                        ...requestHeaders,
                        ...wrappedRequestHeaders,
                    }),
                'getWorkflowStates',
